...
class MatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create match" do
    assert_difference('Match.count') do
      post matches_url, params: { match: { start_date: @match.start_date, title: @match.title } }
    end
  ...
  test "should update match" do
    patch match_url(@match), params: { match: { start_date: @match.start_date, title: @match.title } }
